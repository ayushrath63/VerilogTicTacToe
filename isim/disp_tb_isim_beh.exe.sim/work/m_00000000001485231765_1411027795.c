...
#endif
static const char *ng0 = "C:/Xilinx/Projects/CSM152A_Lab4/Lab4_cleaned/display.v";
static int ng1[] = {8, 0};
...
static int ng18[] = {640, 0};
static int ng19[] = {0, 0};
static int ng20[] = {480, 0};
...
LAB20:    t291 = (t0 + 7736);
    ...
    *((unsigned int *)t301) = (t303 | t297);
    xsi_driver_vfirst_trans(t291, 0, 8);
    t304 = (t0 + 7280);
    *((int *)t304) = 1;
...
LAB135:    xsi_vlog_unsigned_bit_combine(t254, 9, t285, 9, t290, 9);
    goto LAB139;
...
static void Always_120_13(char *t0)
{
    char t16[8];
    char t17[8];
    char t31[8];
...
LAB36:    t295 = *((unsigned int *)t17);
    t296 = (~(t295));
    t297 = *((unsigned int *)t14);
    t298 = (t296 || t297);
    if (t298 > 0)
        goto LAB37;
...
LAB42:    memcpy(t16, t360, 8);

LAB43:    t387 = (t0 + 4600);
    xsi_vlogvar_wait_assign_value(t387, t16, 0, 0, 8, 0LL);
    goto LAB2;
...
LAB14:    if (*((unsigned int *)t13) < *((unsigned int *)t16))
        goto LAB12;
...
LAB18:    xsi_set_current_line(128, ng0);
    ...
    t11 = ((char*)((ng15)));
    memset(t16, 0, 8);
    xsi_vlog_unsigned_minus(t16, 32, t5, 32, t11, 32);
    memset(t17, 0, 8);
    t12 = (t4 + 4);
    if (*((unsigned int *)t12) != 0)
        goto LAB20;
...
LAB23:    if (*((unsigned int *)t4) < *((unsigned int *)t16))
        goto LAB21;
...
LAB15:    xsi_set_current_line(125, ng0);
    ...
    t30 = ((char*)((ng15)));
    memset(t31, 0, 8);
    xsi_vlog_unsigned_add(t31, 32, t29, 10, t30, 32);
    t32 = (t0 + 4416);
...
LAB24:    xsi_set_current_line(129, ng0);
    ...
    t21 = ((char*)((ng15)));
    memset(t31, 0, 8);
    xsi_vlog_unsigned_add(t31, 32, t20, 10, t21, 32);
    t27 = (t0 + 4508);
    xsi_vlogvar_wait_assign_value(t27, t31, 0, 0, 10, 0LL);
    goto LAB26;
...
LAB39:    xsi_vlog_unsigned_bit_combine(t16, 8, t268, 8, t360, 8);
    goto LAB43;

LAB41:    memcpy(t16, t268, 8);
    goto LAB43;

LAB44:    t52 = *((unsigned int *)t43);
...
extern void work_m_00000000001485231765_1411027795_init()
{
	static char *pe[] = {(void *)Cont_45_0,(void *)Cont_53_1,(void *)Cont_79_2,(void *)Cont_80_3,(void *)Cont_81_4,(void *)Cont_82_5,(void *)Cont_83_6,(void *)Cont_84_7,(void *)Cont_85_8,(void *)Cont_86_9,(void *)Cont_87_10,(void *)Cont_90_11,(void *)Cont_100_12,(void *)Always_120_13};
	xsi_register_didat("work_m_00000000001485231765_1411027795", "isim/disp_tb_isim_beh.exe.sim/work/m_00000000001485231765_1411027795.didat");
